...
namespace Niflib
{
	...
	enum SkyrimHavokMaterial : unsigned int
	{
	...
	enum SkyrimShaderPropertyFlags1 : unsigned int
	{
	...
	enum BSShaderFlags : unsigned int
	{
	...
	enum SkyrimShaderPropertyFlags2 : unsigned int
	{
